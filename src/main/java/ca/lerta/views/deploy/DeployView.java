package ca.lerta.views.deploy;

import ca.lerta.data.entity.SampleAddress;
import ca.lerta.data.service.SampleAddressService;
import ca.lerta.views.MainLayout;
...
@PermitAll
public class DeployView extends Div {
    ...
    public DeployView(SampleAddressService addressService) {
